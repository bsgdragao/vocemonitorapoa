...
class UpaBomJesusPed extends StatefulWidget {

  @override
  _UpaBomJesusPedState createState() => _UpaBomJesusPedState();
}
class _UpaBomJesusPedState extends State<UpaBomJesusPed> {
  // Strings de referencia do hospital
  int idHospital = 17;
  String idComentarios = "17";
  String idHospitalTime = "171";
  //String com o nome do Hospital
  String nomeHospital = "UPA Bom Jesus Pediatria";
