...
class HospitalSantoAntonio extends StatefulWidget {

  @override
  _HospitalSantoAntonioState createState() => _HospitalSantoAntonioState();
}
class _HospitalSantoAntonioState extends State<HospitalSantoAntonio> {
  // Strings de referencia do hospital
  int idHospital = 12;
  String idComentarios = "12";
  String idHospitalTime = "112";
  //String com o nome do Hospital
  String nomeHospital = "Hospital Santo Antônio";
