...
class HospitalClinicasPediatria extends StatefulWidget {

  @override
  _HospitalClinicasPediatriaState createState() => _HospitalClinicasPediatriaState();
}
class _HospitalClinicasPediatriaState extends State<HospitalClinicasPediatria> {
  // Strings de referencia do hospital
  int idHospital = 3;
  String idComentarios = "3";
  String idHospitalTime = "31";
  //String com o nome do Hospital
  String nomeHospital = "Hospital de Clinicas Pediatria";
