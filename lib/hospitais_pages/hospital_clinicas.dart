...
class HospitalClinicas extends StatefulWidget {

  @override
  _HospitalClinicasState createState() => _HospitalClinicasState();
}
class _HospitalClinicasState extends State<HospitalClinicas> {
  // Strings de referencia do hospital
  int idHospital = 2;
  String idComentarios = "2";
  String idHospitalTime = "21";
  //String com o nome do Hospital
  String nomeHospital = "Hospital de Clinicas";
