...
class UpaBomJesus extends StatefulWidget {

  @override
  _UpaBomJesusState createState() => _UpaBomJesusState();
}
class _UpaBomJesusState extends State<UpaBomJesus> {
  // Strings de referencia do hospital
  int idHospital = 16;
  String idComentarios = "16";
  String idHospitalTime = "161";
  //String com o nome do Hospital
  String nomeHospital = "UPA Bom Jesus";
