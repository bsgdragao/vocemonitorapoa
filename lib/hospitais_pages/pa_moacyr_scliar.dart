...
class UpaMoacyr extends StatefulWidget {

  @override
  _UpaMoacyrState createState() => _UpaMoacyrState();
}
class _UpaMoacyrState extends State<UpaMoacyr> {
  // Strings de referencia do hospital
  int idHospital = 23;
  String idComentarios = "23";
  String idHospitalTime = "231";
  //String com o nome do Hospital
  String nomeHospital = "Upa Moacyr Scliar";
