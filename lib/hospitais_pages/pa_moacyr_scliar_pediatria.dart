...
class UpaMoacyrPed extends StatefulWidget {

  @override
  _UpaMoacyrPedState createState() => _UpaMoacyrPedState();
}
class _UpaMoacyrPedState extends State<UpaMoacyrPed> {
  // Strings de referencia do hospital
  int idHospital = 24;
  String idComentarios = "24";
  String idHospitalTime = "241";
  //String com o nome do Hospital
  String nomeHospital = "UPA Moacyr Scliar Pediatria";
