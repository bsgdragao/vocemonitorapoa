...
class HospitalConceicaoPed extends StatefulWidget {

  @override
  _HospitalConceicaoPedState createState() => _HospitalConceicaoPedState();
}
class _HospitalConceicaoPedState extends State<HospitalConceicaoPed> {
  // Strings de referencia do hospital
  int idHospital = 7;
  String idComentarios = "7";
  String idHospitalTime = "71";
  //String com o nome do Hospital
  String nomeHospital = "Hospital da Criança Nossa Senhora da Conceição";
