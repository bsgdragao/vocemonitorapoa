...
class UpaCruzeiroPed extends StatefulWidget {

  @override
  _UpaCruzeiroPedState createState() => _UpaCruzeiroPedState();
}
class _UpaCruzeiroPedState extends State<UpaCruzeiroPed> {
  // Strings de referencia do hospital
  int idHospital = 19;
  String idComentarios = "19";
  String idHospitalTime = "191";
  //String com o nome do Hospital
  String nomeHospital = "Upa Cruzeiro Ped";
