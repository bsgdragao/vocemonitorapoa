...
class HospitalProntoSocorro extends StatefulWidget {

  @override
  _HospitalProntoSocorroState createState() => _HospitalProntoSocorroState();
}
class _HospitalProntoSocorroState extends State<HospitalProntoSocorro> {
  // Strings de referencia do hospital
  int idHospital = 8;
  String idComentarios = "8";
  String idHospitalTime = "81";
  //String com o nome do Hospital
  String nomeHospital = "Hospital Pronto Socorro";
