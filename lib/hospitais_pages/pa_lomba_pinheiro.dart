...
class UpaLomba extends StatefulWidget {

  @override
  _UpaLombaState createState() => _UpaLombaState();
}
class _UpaLombaState extends State<UpaLomba> {
  // Strings de referencia do hospital
  int idHospital = 20;
  String idComentarios = "20";
  String idHospitalTime = "201";
  //String com o nome do Hospital
  String nomeHospital = "UPA da Lomba do Pinheiro";
