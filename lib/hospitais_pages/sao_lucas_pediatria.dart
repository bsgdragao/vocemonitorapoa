...
class HospitalSaoLucasPed extends StatefulWidget {

  @override
  _HospitalSaoLucasPedState createState() => _HospitalSaoLucasPedState();
}
class _HospitalSaoLucasPedState extends State<HospitalSaoLucasPed> {
  // Strings de referencia do hospital
  int idHospital = 15;
  String idComentarios = "15";
  String idHospitalTime = "151";
  //String com o nome do Hospital
  String nomeHospital = "Hospital São Lucas Pediatria";
