...
class HospitalRestinga extends StatefulWidget {

  @override
  _HospitalRestingaState createState() => _HospitalRestingaState();
}
class _HospitalRestingaState extends State<HospitalRestinga> {
  // Strings de referencia do hospital
  int idHospital = 9;
  String idComentarios = "9";
  String idHospitalTime = "91";
  //String com o nome do Hospital
  String nomeHospital = "Hospital da Restinga";
