...
class HospitalSaoLucas extends StatefulWidget {

  @override
  _HospitalSaoLucasState createState() => _HospitalSaoLucasState();
}
class _HospitalSaoLucasState extends State<HospitalSaoLucas> {
  // Strings de referencia do hospital
  int idHospital = 14;
  String idComentarios = "14";
  String idHospitalTime = "141";
  //String com o nome do Hospital
  String nomeHospital = "Hospital São Lucas";
