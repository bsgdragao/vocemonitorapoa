...
class UpaLombaPed extends StatefulWidget {

  @override
  _UpaLombaPedState createState() => _UpaLombaPedState();
}
class _UpaLombaPedState extends State<UpaLombaPed> {
  // Strings de referencia do hospital
  int idHospital = 22;
  String idComentarios = "22";
  String idHospitalTime = "221";
  //String com o nome do Hospital
  String nomeHospital = "UPA Lomba do Pinheiro Pediatria";
