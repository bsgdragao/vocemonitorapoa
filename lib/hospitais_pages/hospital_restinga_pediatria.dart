...
class HospitalRestingaPed extends StatefulWidget {

  @override
  _HospitalRestingaPedState createState() => _HospitalRestingaPedState();
}
class _HospitalRestingaPedState extends State<HospitalRestingaPed> {
  // Strings de referencia do hospital
  int idHospital = 10;
  String idComentarios = "10";
  String idHospitalTime = "101";
  //String com o nome do Hospital
  String nomeHospital = "Hospital da Restinga Pediatria";
