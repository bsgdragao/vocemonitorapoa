...
class PresidenteVargas extends StatefulWidget {

  @override
  _PresidenteVargasState createState() => _PresidenteVargasState();
}
class _PresidenteVargasState extends State<PresidenteVargas> {
  // Strings de referencia do hospital
  int idHospital = 5;
  String idComentarios = "5";
  String idHospitalTime = "51";
  //String com o nome do Hospital
  String nomeHospital = "Hospital Materno Infantil Presidente Vargas";
