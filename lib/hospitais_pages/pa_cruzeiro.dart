...
class UpaCruzeiro extends StatefulWidget {

  @override
  _UpaCruzeiroState createState() => _UpaCruzeiroState();
}
class _UpaCruzeiroState extends State<UpaCruzeiro> {
  // Strings de referencia do hospital
  int idHospital = 18;
  String idComentarios = "18";
  String idHospitalTime = "181";
  //String com o nome do Hospital
  String nomeHospital = "UPA da Cruzeiro";
