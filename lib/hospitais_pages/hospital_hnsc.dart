...
class HospitalConceicao extends StatefulWidget {

  @override
  _HospitalConceicaoState createState() => _HospitalConceicaoState();
}
class _HospitalConceicaoState extends State<HospitalConceicao> {
  // Strings de referencia do hospital
  int idHospital = 6;
  String idComentarios = "6";
  String idHospitalTime = "61";
  //String com o nome do Hospital
  String nomeHospital = "Hospital Nossa Senhora da Conceição";
