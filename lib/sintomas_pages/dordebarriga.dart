...
import 'package:vocemonitorapoa/select_hospitais/atende_barriga_infantil.dart';
...
class DorDeBarrigaPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: AutoSizeText("Estômago", style: TextStyle(
