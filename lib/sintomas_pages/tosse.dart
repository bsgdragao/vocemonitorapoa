...
import 'package:vocemonitorapoa/select_hospitais/atende_tosse.dart';
import 'package:vocemonitorapoa/select_hospitais/atende_tosse_infantil.dart';

class TossePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Tosse", style: TextStyle(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  new MaterialPageRoute(
                    builder: (context) => new AtendeTosse(),
                  ),
                );
              },
            ),
            ...
            child: RaisedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  new MaterialPageRoute(
                    builder: (context) => new AtendeTosseInfantil(),
                  ),
                );
              },
            ),
